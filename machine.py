...
class Machine(object):
    ...
    __available = ["arml", "armb", "armtl", "armtb", "sh4", "x86_16", "x86_32",
                   ...
                   "aarch64l", "aarch64b", "ppc32b", "mepl", "mepb","nir"]
    ...
    def __init__(self, machine_name):
        ...
        elif machine_name == "nir":
            from miasm.arch.nir.disasm import dis_nir as dis_engine
            from miasm.arch.nir import arch
            mn = arch.mn_nir
            from miasm.arch.nir.ira import ir_a_nir as ira
            from miasm.arch.nir.sem import ir_nir as ir
